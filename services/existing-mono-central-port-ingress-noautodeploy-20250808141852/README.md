# existing-mono-central-port-ingress-noautodeploy-20250808141852
...
```
docker build -t existing-mono-central-port-ingress-noautodeploy-20250808141852:latest .
docker run -p:5030:9999 existing-mono-central-port-ingress-noautodeploy-20250808141852:latest
```
